...
function l2Change() {
    l2 = parseFloat(document.getElementById("l2in").value);
...
function calculateFreq(c1,l1,l2){
    var L=l1+l2;
    var OpFreq=1/(2*Math.PI*Math.sqrt(L*c1*Math.pow(10,-12)));
    return OpFreq;
...
function checkOutput(){
    ...
    var correctAns=calculateFreq(c1,l1,l2).toFixed(3);
    //console.log(Ans);
...
function checkNull(){
   if (document.getElementById("c1").value == "") {
    ...
    else if (document.getElementById("l2").value == "") {
        alert("Enter the value of l2");
        document.getElementById("l2").style.borderColor = "red";
        return false;
    }
